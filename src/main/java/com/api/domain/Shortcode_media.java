...
public class Shortcode_media {
    ...
    private EdgeList<Edge<Node_comment>> edge_media_to_parent_comment;
    private EdgeList<Edge<Node_comment>> edge_media_to_hoisted_comment;
    ...
    public EdgeList<Edge<Node_comment>> getEdge_media_to_parent_comment() {
        return edge_media_to_parent_comment;
    }

    public void setEdge_media_to_parent_comment(EdgeList<Edge<Node_comment>> edge_media_to_parent_comment) {
        this.edge_media_to_parent_comment = edge_media_to_parent_comment;
    }

    public EdgeList<Edge<Node_comment>> getEdge_media_to_hoisted_comment() {
        return edge_media_to_hoisted_comment;
    }

    public void setEdge_media_to_hoisted_comment(EdgeList<Edge<Node_comment>> edge_media_to_hoisted_comment) {
