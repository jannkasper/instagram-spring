...
public class Location {
    ...
    public Edge_owner_to_timeline_media getEdge_location_to_media() {
        return edge_location_to_media;
    }

    public void setEdge_location_to_media(Edge_owner_to_timeline_media edge_location_to_media) {
        this.edge_location_to_media = edge_location_to_media;
    }

    public Edge_owner_to_timeline_media getEdge_location_to_top_posts() {
        return edge_location_to_top_posts;
    }

    public void setEdge_location_to_top_posts(Edge_owner_to_timeline_media edge_location_to_top_posts) {
