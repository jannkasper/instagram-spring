...
public class Location {
    ...
    private EdgeList<Edge<NodePost>> edge_location_to_media;
    private EdgeList<Edge<NodePost>> edge_location_to_top_posts;
    ...
    public EdgeList<Edge<NodePost>> getEdge_location_to_media() {
        return edge_location_to_media;
    }

    public void setEdge_location_to_media(EdgeList<Edge<NodePost>> edge_location_to_media) {
        this.edge_location_to_media = edge_location_to_media;
    }

    public EdgeList<Edge<NodePost>> getEdge_location_to_top_posts() {
        return edge_location_to_top_posts;
    }

    public void setEdge_location_to_top_posts(EdgeList<Edge<NodePost>> edge_location_to_top_posts) {
