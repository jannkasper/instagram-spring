...
public class User {
    ...
    private EdgeList<Edge<NodePost>> edge_web_feed_timeline;
    private EdgeList<Edge<NodePost>> edge_owner_to_timeline_media;
    ...
    private EdgeList<Edge<NodePost>> edge_felix_video_timeline;
    ...
    public EdgeList<Edge<NodePost>> getEdge_web_feed_timeline() {
        return edge_web_feed_timeline;
    }

    public void setEdge_web_feed_timeline(EdgeList<Edge<NodePost>> edge_web_feed_timeline) {
    ...
    public EdgeList<Edge<NodePost>> getEdge_owner_to_timeline_media() {
        return edge_owner_to_timeline_media;
    }

    public void setEdge_owner_to_timeline_media(EdgeList<Edge<NodePost>> edge_owner_to_timeline_media) {
    ...
    public EdgeList<Edge<NodePost>> getEdge_felix_video_timeline() {
        return edge_felix_video_timeline;
    }

    public void setEdge_felix_video_timeline(EdgeList<Edge<NodePost>> edge_felix_video_timeline) {
